...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Animate the main title with char split logic
      // Note: We are using a simple fade up here for general, 
      // but could use animateTitle if we split words. 
      // Let's stick to timeline for Hero as it needs sequence.
